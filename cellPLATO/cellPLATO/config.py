...
SAMPLING_INTERVAL = 15/60 # time between frames in minutes
TRACK_FILENAME = '.h5'
Z_SCALE = 1.00
...
DATA_PATH = 'D://Michael_Shannon/SHIRA_COLLAB/2022-10-24_HSPConly/'
CTL_LABEL = 'Condition_HSPC_Vehicle'
CONDITIONS_TO_INCLUDE = ['Condition_HSPC_Vehicle', 'Condition_HSPC_AMD3100'] #'Condition_Stopped_artificial'

CONDITION_SHORTLABELS = ['Vehicle', 'AMD3100']
USE_SHORTLABELS = True
PERFORM_RIPLEYS = True
DATASET_SHORTNAME = '2022_12_29_11AM_HSPConly-on-EL08-AMD3100'
...
SAMPLING_INTERVAL_LIST= [15/60,15/60]#[1,1, 1/60,1/60]
...
RIP_R = 34 # Radius to search when calculating Ripleys K. 1.5 * the size of a cell = 12+6=18
...
DATA_FILTERS = {
  "area": (30, 1000), # Warning: range will change if self-normalized
  "ntpts": (2,10000)
